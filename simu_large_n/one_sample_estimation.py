...
#        U_prime = U + (real_Rn_gamma - expec_Rn_gamma)/abs(real_Rn_gamma - expec_Rn_gamma) * np.random.normal(141 * n**(-hat_alpha), 52 * n**(-hat_alpha))
        ...
        hat_lambda_1_prime = hat_alpha * math.log(n) / gamma
        hat_r_1_prime = (hat_lambda_1_prime * real_Rn_gamma * (3 * hat_lambda_1_prime - hat_lambda_0)) / (
                                2 * (hat_lambda_1_prime - hat_lambda_0)) * n * math.exp(-hat_lambda_1_prime * gamma)
        hat_alpha_prime = 1 - math.log(real_In_exist_at_gamma, n) - \
                          math.log((-hat_lambda_0 * hat_r_1_prime)/hat_lambda_1_prime , n)
...
#        hat_r_1_star3 = 0
    ...
    return zeta[0], gamma, gamma_star, expec_In_exist_to_end, real_In_exist_to_end, real_In_exist_at_gamma, \
           expec_Rn_gamma, real_Rn_gamma, Phi_0_gamma, Z0_gamma, hat_lambda_0, hat_lambda_1, hat_r_1, \
            hat_alpha, U, hat_lambda_1_prime, hat_r_1_prime, hat_alpha_prime
